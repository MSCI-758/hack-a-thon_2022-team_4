...
author: "Abigail Kreuser, Peggy Bernish, Chloé Keck, Gwen Hopper"
date: '2022-05-02'
...
### Intro:
Our group found that the priority ranking was a vague indicator of the differences among the impaired water bodies. The majority of the impaired water bodies on the 303d list were ranked as a `3`, which   We looked for relationships between priority ranking and basin, cause, and use. We further investigate the causes of water body impairment in the 2018 data to disseminate trends. 
...
![Count of uses and priority.](figures/prank_uses_barplot.png){width=60%}
...
The ratio of priority rank for each cause could indicate that the causes with near term priority, rank=2, solutions already exist for TMDL to apply or are possible to develop plans for restoration. Total nitrogen (TN) and lead (PB) have a majority of near term priority rankings. Total phosphorous (TP), hydrogen ion concentration (PH), and *Escherichia coli* (ECOLI) have more priority rank =2 than others --- THIS AINT GREAT IDK IF WE WANT TO SAY ANYTHING ABOUT THEM. 
...
Aquatic life had the most impairments, and the most variation in causes. We were surprised by ranking and the only actively managed water body in 2018 being AL. 
